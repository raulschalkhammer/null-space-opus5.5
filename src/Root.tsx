...
export const RemotionRoot: React.FC = () => (
	<>
		...
		<Composition id="Final1" component={Final1} durationInFrames={edls.ch1.total} fps={FPS} width={WIDTH} height={HEIGHT} />
		<Composition id="Final2" component={Final2} durationInFrames={edls.ch2.total} fps={FPS} width={WIDTH} height={HEIGHT} />
